...
Finalmente, pela definição de mediana de uma variável aleatória contínua tomando valor em $\mathbb{R}$ como o valor real $m$ tal que $P(Y>m) = P(Y <m) = \frac{1}{2}$, conclui-se que $z$ é a mediana, já que metade das variáveis aleatórias de $Y$ se encontra acima de $z$ e a outra metade abaixo de $z$.
